                                    ...
                                    <div class="col-lg-4">
                                        <div class="card mb-4 shadow-sm" style="background-color: lightgray">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="my-3"> {{ $student->Company ? $student->Company->name : '' }}</p>
                                        ...
                                        <div class="card mb-4" style="background-color: lightgray">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <p class="text-muted mb-0"> {{ $student->dob == '' ? 'N/A' : $student->dob }}</p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <p class="text-muted mb-0"> {{ $student->phone_no == '' ? 'N/A' : $student->phone_no }}</p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <p class="text-muted mb-0">{{ $student->address == '' ? 'N/A' : $student->address }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
